 ...
 */
final class Version20220305170615 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE coupon DROP name');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE coupon ADD name VARCHAR(50) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE code code VARCHAR(10) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE description description LONGTEXT NOT NULL COLLATE `utf8mb4_unicode_ci`');
        ...
        $this->addSql('ALTER TABLE `order` CHANGE reference reference VARCHAR(20) NOT NULL COLLATE `utf8mb4_unicode_ci`');
